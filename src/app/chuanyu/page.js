...
async function getChuanyuData() {
  ...
  const chuanyuPage = data.data.find((item) => {
    return item.page.some((page) => page.title === "chuanyu");
  });
  return chuanyuPage.page.find(
  ...
  return (
    <main className="md:min-w-[1420px] @container">
      <section className="w-full min-h-[1000px] md:min-h-[100vh] relative md:flex md:justify-center  @min-[1420px]:px-[5vw]">
        <Image
          src="/images/chuanyu-bg-mobile@1x.png"
          srcSet="/images/chuanyu-bg-mobile@1x.png 1x, /images/chuanyu-bg-mobile@2x.png 2x"
          alt="Background"
          fill
        ...
        <Image
          src="/images/chuanyu-bg@1x.png"
          srcSet="/images/chuanyu-bg@1x.png 1x, /images/chuanyu-bg@2x.png 2x"
          alt="Background"
          fill
      ...
      <section className="w-full h-full bg-primary-mist flex flex-col justify-center items-center @min-[1420px]:px-[5vw] pt-[10vh] md:pt-[15vh]">
