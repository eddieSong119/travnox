...
async function getNorthData() {
  ...
  const northPage = data.data.find((item) => {
    return item.page.some((page) => page.title === "north");
  });
  return northPage.page.find(
  ...
  return (
    <main className="md:min-w-[1420px] @container">
      <section className="w-full min-h-[1000px] md:min-h-[100vh] relative md:flex md:justify-center  @min-[1420px]:px-[5vw]">
        ...
        <Image
          src="/images/north-bg@1x.png"
          srcSet="/images/north-bg@1x.png 1x, /images/north-bg@2x.png 2x"
          alt="Background"
          fill
        ...
        <div className="px-[5vw] md:w-[1420px] md:px-0 md:flex md:justify-start md:items-start">
          <div className="relative z-10 flex flex-col items-start justify-center px-[5vw] pt-[80px] md:max-w-[700px] md:pt-[150px] md:px-0">
            ...
            <h1 className="text-primary-midnight font-pp-museum text-[32px] md:text-[60px] font-[500] mb-4">
              {title}
            </h1>
      ...
      <section className="w-full h-full bg-primary-steel flex flex-col justify-center items-center @min-[1420px]:px-[5vw] pt-[10vh] md:pt-[15vh]">
        <div className="w-full md:w-[1420px] h-[650px] md:h-[900px] relative mb-[200px] md:mb-[300px]">
          <p className="text-[24px] md:text-[40px] font-pp-museum font-[500] text-primary-midnight absolute -top-[60px] left-5">
          ...
          <div className="w-[144px] md:w-[376px] absolute right-5 top-[180px] md:left-0 md:top-[200px]">
            <Polaroid
              ...
              padding="p-[5px]"
            />
            <p className="text-[12px] md:text-[20px] font-pp-museum text-primary-midnight mt-5 text-center">
        ...
        <div className="w-full md:w-[1420px] h-[650px] md:h-[600px] relative mb-[100px]">
          <p className="text-[24px] md:text-[40px] font-pp-museum font-[500] text-primary-midnight absolute -top-[100px] right-5">
      ...
      <section className="w-full relative h-auto bg-[#DDE2E7] flex flex-col items-center justify-center">
        <img
        ...
        <div className="md:w-[700px] mt-[100px]">
          {detailedItinerary && detailedItinerary.length > 0 && (
            <div className="mb-[80px] px-[5vw]">
              <h2 className="text-primary-midnight font-pp-museum text-[24px] md:text-[32px] font-[500] mb-6 leading-[1.2] text-center">
                Detailed Itinerary
              </h2>
